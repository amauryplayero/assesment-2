...
//CODE HERE
// console.log(empOne.getSchedule(`Jess`, `Weekday mornings, weekday afternoons`))
...
//CODE HERE
manager.getEmployees(`Winston`, `Cece and Schmidt`)
...
//CODE HERE 
console.log(manager.addEmployee(`Ramiro`, `one second a week only`))
